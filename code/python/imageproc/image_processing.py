...
def brightPixel(pixel):
    red_intensity = int(pixel[0])
    green_intensity = int(pixel[1])
    blue_intensity = int(pixel[2])

    if ((red_intensity <= 245) and (green_intensity <= 245) and (blue_intensity <= 245)):
        return (pixel[0]+10, pixel[1]+10, pixel[2]+10)
    elif ((red_intensity <= 245) and (green_intensity <= 245)):
        return (pixel[0]+10, pixel[1]+10, pixel[2])
    elif ((red_intensity <= 245) and (blue_intensity <= 245)):
        return (pixel[0]+10, pixel[1], pixel[2]+10)
    elif ((green_intensity <= 245) and (blue_intensity <= 245)):
        return (pixel[0], pixel[1]+10, pixel[2]+10)
    elif (red_intensity <= 245):
        return (pixel[0]+10, pixel[1], pixel[2])
    elif (green_intensity <= 245):
        return (pixel[0], pixel[1]+10, pixel[2])
    elif (blue_intensity <= 245):
...
def darkPixel(pixel):
    ...
    if ((red_intensity >= 10) and (green_intensity >= 10) and (blue_intensity >= 10)):
        return (pixel[0]-10, pixel[1]-10, pixel[2]-10)
    elif ((red_intensity >= 10) and (green_intensity >= 10)):
        return (pixel[0]-10, pixel[1]-10, pixel[2])
    elif ((red_intensity >= 10) and (blue_intensity >= 10)):
        return (pixel[0]-10, pixel[1], pixel[2]-10)
    elif ((green_intensity >= 10) and (blue_intensity >= 10)):
        return (pixel[0], pixel[1]-10, pixel[2]-10)
    elif (red_intensity >= 10):
        return (pixel[0]-10, pixel[1], pixel[2])
    elif (green_intensity >= 10):
        return (pixel[0], pixel[1]-10, pixel[2])
    elif (blue_intensity >= 10):
        return (pixel[0], pixel[1], pixel[2]-10)
    else:
        return (pixel[0], pixel[1], pixel[2])
...
def brighten(image_surf):
    ...
    for x in range(rows):
        for y in range(cols):
            pixels3d[x,y] = brightPixel(pixels3d[x,y])
