...
intersect nil _ = nil
intersect (h::t) l = ite (member h l)
                          (h::(intersect t l))
                          (intersect (t) l)
...
-- pairelt takes an elt h and a list b and returns list of all
...
pairlist nil l = nil
pairlist (h::t) l = (pairelt h l)++(pairlist t l)
...
list_breakup1_helper: list a -> list a
list_breakup1_helper (h::t) = (h::nil)

||| separates the elements in a list into a list containing a list of those
||| elements
list_breakup1: list a -> list (list a)
list_breakup1 (h::t) = ((list_breakup1_helper (h::t))::(list_breakup1 t))

||| appends two lists of lists
list_list_append: list (list a) -> list (list a) -> list (list a)
list_list_append ((nil)::nil) ll2 = ll2
list_list_append ((h::t)::ll1) ll2 = ((h::t)::(list_list_append ((ll1) (ll2))))

list_powerset: list a -> list (list a)
list_powerset nil = ((nil)::nil)
list_powerset (h::nil) = ((nil)::(h::nil)::nil)
list_powerset (h::t) = list_list_append (list_list_append ((nil)::nil) (list_breakup1 (h::t))) (h::t)
